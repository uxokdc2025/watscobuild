            ...
            <section className="border-b p-3 md:border-r md:border-b-0">
              ...
              <div className="space-y-1">
                {suggestions.map((item, index) => (
                  <button key={item.text} type="button" role="option" aria-selected={index === active} onMouseEnter={() => setActive(index)} onClick={() => submit(item.text)} className={cn("flex w-full items-center justify-between gap-3 rounded-sm px-2 py-2 text-left text-sm transition-colors hover:bg-muted focus-visible:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring", index === active && "bg-muted text-foreground")}>
            ...
            <section className="p-3">
              ...
              <div className="space-y-1">
                {PRODUCTS.map((product) => (
                    <button key={product.item} type="button" onClick={() => submit(product.title)} className="flex w-full items-center gap-3 rounded-sm px-2 py-2 text-left transition-colors hover:bg-muted focus-visible:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring">
