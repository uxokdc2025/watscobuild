...
const ucPackSize: PdpProduct = {
  ...
  mfg: "97087",
  thumbnailCount: 1,
  images: ["/uc/safe-t-switch-97087.png"],
  description: {
    intro:
...
const ucPoints: PdpProduct = {
  ...
  commerce: {
    ...
    uom: "EACH",
    points: 1,
    yourBranch: { name: "Ybor City #2541", stock: 63 },
    nearbyBranches: [{ qty: 43, name: "Other Branches" }],
  },
  fbt: [
    {
      label: "Best Sellers",
      items: [
        { id: "tp-b21-2", title: 'TRADEPRO® - 2-1/2" Chip Brush', item: "TP-B21/2", mfg: "TP-B21/2", image: "/uc/fbt-tp-b212.avif", price: 0.7, branchQty: 0, branchName: "", nearbyQty: 0, stockStatus: "IN STOCK", stockBranch: "Ybor City #2541" },
        { id: "tp-acb2", title: 'TRADEPRO® - 2" Chip/Mastic Brush', item: "TP-ACB2", mfg: "TP-ACB2", image: "/uc/fbt-tp-acb2.avif", price: 2.1, branchQty: 0, branchName: "", nearbyQty: 0, stockStatus: "IN STOCK", stockBranch: "Ybor City #2541" },
        { id: "tp-b3", title: 'TRADEPRO® - 3" Chip Brush', item: "TP-B3", mfg: "TP-B3", image: "/uc/fbt-tp-b3.avif", price: 0.8, branchQty: 0, branchName: "", nearbyQty: 0, stockStatus: "IN STOCK", stockBranch: "Ybor City #2541" },
        { id: "scrim-407a", title: 'Associated Sales - 407A-12-B - White Construction Scrim Tape - 3" x 150\'', item: "407A-2", mfg: "407A-12-B", image: "/uc/fbt-scrim-tape.avif", price: 8.9, branchQty: 0, branchName: "", nearbyQty: 0, stockStatus: "IN STOCK", stockBranch: "Ybor City #2541" },
        { id: "bmp-bmtd04", title: 'BMP - 4" x 1" Condenser Tie Down Hurricane Bracket 4/PK', item: "BMTD04", mfg: "BMTD04", image: "/uc/fbt-bmp-bracket.avif", price: 5.7, branchQty: 0, branchName: "", nearbyQty: 0, stockStatus: "IN STOCK", stockBranch: "Ybor City #2541" },
        { id: "polyken-367", title: 'Polyken® - 367-17 - Silver Aluminum Foil Mastic Tape - 3" X 100\'', item: "367-17-3", mfg: "1086863", image: "/uc/fbt-polyken-tape.avif", price: 46.8, branchQty: 0, branchName: "", nearbyQty: 0, stockStatus: "IN STOCK", stockBranch: "Ybor City #2541" },
        { id: "tp-36nstrap", title: 'TRADEPRO® - 36" Duct Straps', item: "TP-36NSTRAP", mfg: "TP-36NSTRAP", price: 12.8, branchQty: 0, branchName: "", nearbyQty: 0, stockStatus: "IN STOCK", stockBranch: "Ybor City #2541" },
      ],
    },
  ...
  fbt: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          item: "40NIC",
          mfg: "40NIC",
          image: "/uc/fbt-compressed-gas.webp",
          price: 16.79,
          branchQty: 8,
          branchName: "Baker Jacksonville #301",
          nearbyQty: 53,
...
const ucStrikeThru: PdpProduct = {
  ...
  customersAlsoPurchased: [
    ...
    },
    {
      ...
      item: "197214A",
      mfg: "701-043",
      image: "/uc/cap-nylon-adapter.jpeg",
      pct: 10,
      price: 5.26,
      branchQty: 27,
      branchName: "Durham NC #1",
    ...
    },
    {
      id: "tradepro-80200",
      brand: "TRADEPRO®",
      title: "Non-Fused Pull-Out Disconnect Switch - 60 Amp",
      item: "80200",
      mfg: "TP-60AMP-NF",
      image: "/uc/cap-disconnect.avif",
      pct: 10,
      price: 29.42,
      wasPrice: 34.72,
      branchQty: 46,
