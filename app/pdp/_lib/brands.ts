...
export const BRANDS: Record<string, BrandChrome> = {
  carrier: {
    ...
    footerColumns: [
      ...
      { title: "Resources", links: ["Clearance", "Credit Application", "Rebates", "SEER2", "Videos"] },
      { title: "CE Tools", links: ["CE Pay", "CE Rewards", "EasyStock", "Service Express"] },
  ...
  baker: {
    ...
    accent: "#c8102e",
    phone: "(800) 217-4698",
    nav: ["HVAC", "Refrigeration", "Foodservice", "Parts", "Supplies", "Resources"],
    footerColumns: [
      { title: "All Product Lines", links: ["Residential HVAC", "Commercial HVAC", "Refrigeration", "Parts", "Supplies"] },
      { title: "Sales & Ordering", links: ["Ordering", "Sales Centers", "Returns & Exchanges", "Special Orders"] },
      { title: "Customer Service", links: ["Contact Us", "eCommerce Support", "HVAC Technical Support", "FAQ"] },
      { title: "Resources", links: ["About Us", "Brand Portfolio", "Careers", "Customer Financing"] },
    ],
