...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Product Card", href: "/components/product-card" },
      { label: "PLP Patterns", href: "/components/plp" },
      { label: "Save + AHRI", href: "/components/save-ahri" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Account Menus (v1 vs v2)", href: "/components/account-menus" },
