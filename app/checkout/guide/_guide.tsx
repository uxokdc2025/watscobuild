...
const GUIDES: BrandGuide[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Order notes", scenario: "account-job-context", status: "in-flow", note: "no distinct notes field yet" },
      { label: "Inventory-confirmed / stock notice", status: "in-flow", note: "base shows warning notices; positive confirm not distinct" },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Switch account", scenario: "account-job-context", status: "in-flow", note: "account context is read-only in checkout" },
      ...
      { label: "Special handling → required comments", scenario: "review-coupon-special-handling", status: "in-flow", note: "acknowledgement checkbox only; no comments field" },
  ...
  },
  {
    ...
    rows: [
      { label: "Order Details + send-confirmation-email / notify salesperson", scenario: "account-job-context", status: "in-flow", note: "notify toggles not built as distinct controls" },
      { label: "4 delivery methods (Pickup / Truck / Freight / UPS)", scenario: "delivery-pickup-routing", status: "solved" },
      { label: "Cash on Pickup", scenario: "terms-or-credit-card", status: "in-flow", note: "Account terms / COD present; no distinct Cash-on-Pickup option" },
      { label: "Shared company cards", scenario: "terms-or-credit-card", status: "in-flow", note: "saved cards present; not modeled as shared company cards" },
      { label: "Add shipping address", scenario: "delivery-pickup-routing", status: "solved" },
      { label: "Review (3-column)", scenario: "review-coupon-special-handling", status: "in-flow", note: "review renders in two columns" },
      { label: "Thank-you + print", scenario: "order-confirmation", status: "in-flow", note: "confirmation built; no print action" },
    ],
  },
];
