...
export default function CheckoutClient() {
  ...
  const items = cartItems.length ? cartItems : DEMO_ITEMS;
    ...
    <div className="mx-auto max-w-[var(--layout-max-width)]">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
        <section className="min-w-0 rounded-md border bg-background shadow-sm">
          ...
          {step === "review" ? <ReviewStep items={items} fulfillment={fulfillment} payment={payment} onBack={goBack} onSubmit={() => setSubmitted(true)} /> : null}
        </section>
