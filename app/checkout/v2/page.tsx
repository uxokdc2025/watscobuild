...
export default async function CheckoutV2Page({ searchParams }: { searchParams: Promise<{ case?: string; demo?: string; brand?: string; account?: string }> }) {
